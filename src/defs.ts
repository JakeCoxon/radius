...
export class ParseForExpr extends ParseNodeType {      key = 'forexpr' as const;      constructor(public token: Token, public left: ParseIdentifier | ParseTuple, public expr: ParseNode, public body: ParseNode) { super();} }
