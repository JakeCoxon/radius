...
export class ParseIterator extends ParseNodeType {     key = 'iterator' as const;     constructor(public token: Token, public expr: ParseNode) { super();} }
...
export class ParseFor extends ParseNodeType {          key = 'for' as const;          constructor(public token: Token, public left: ParseNode, public expr: ParseNode, public body: ParseNode) { super();} }
...
export class ParseCast extends ParseNodeType {         key = 'cast' as const;         constructor(public token: Token, public expr: ParseNode, public asType: ParseNode) { super();} }
...
export class ParseForExpr extends ParseNodeType {      key = 'forexpr' as const;      constructor(public token: Token, public left: ParseNode, public expr: ParseNode, public body: ParseNode) { super();} }
...
export class ParseExtract extends ParseNodeType {      key = 'extract' as const;      constructor(public token: Token, public name: ParseIdentifier | ParseSymbol, public args: ParseNode[]) { super();} }
export class ParseMatch extends ParseNodeType {        key = 'match' as const;        constructor(public token: Token, public name: ParseIdentifier | null, public subject: ParseNode, public cases: ParseMatchCase[]) { super();} }
...
export class SubscriptAst extends AstRoot {     key = 'subscript' as const;      constructor(public type: Type, public location: SourceLocation, public left: Ast, public right: Ast, public funcs: {[key: string]: Binding | undefined}) { super() } }
